...
export { default as send } from "./Send.svg"; // lowercase 'send'
export { default as shield } from "./Shield.svg"; // lowercase 'shield'
export { default as star } from "./Star.svg"; // lowercase 'star'
export { default as menu } from "./menu.svg";
export { default as close } from "./close.svg";
export { default as google } from "./google.svg";
export { default as apple } from "./apple.svg";
export { default as arrowUp } from "./arrow-up.svg";
export { default as discount } from "./Discount.svg"; // lowercase 'discount'
